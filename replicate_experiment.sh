...
##
#    echo " >>>>>>>> TAG-RMSProp"
#    python3 -m main --dataset cifar100 --tasks 20 --epochs-per-task 10 --lr 0.00025 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 3 --opt 'param' --b 5 --tag-opt 'rms'
#
#    echo " >>>>>>>> Naive Adagrad "
...
#
#    echo " >>>>>>>> Stable SGD "
#    python3 -m main --dataset cub --tasks 20 --epochs-per-task 1 --lr 0.01 --gamma 0.9 --batch-size 10 --dropout 0.1 --runs 5
##
#    echo " >>>>>>>> Naive RMSProp "
...
#
#    echo " >>>>>>>> OGD "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.01 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'ogd' --mem-size 100
...
##
#    echo " >>>>>>>> TAG-RMSProp"
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 10 --lr 0.0005 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 3 --opt 'param' --b 5 --tag-opt 'rms'
#
#    echo " >>>>>>>> Naive Adagrad "
...
#
#    echo " >>>>>>>> TAG-RMSProp"
#    python3 -m main --dataset cifar100 --tasks 10 --epochs-per-task 1 --lr 0.00005 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'param' --b 5 --tag-opt 'rms'
