...
#    echo " >>>>>>>> Naive SGD "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.1 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5
##
#    echo " >>>>>>>> EWC "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.1 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'ewc' --lambd 1
##
##    echo " >>>>>>>> TAG-EWC "
...
##
#    echo " >>>>>>>> A-GEM "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.05 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'agem' --mem-size 1
###    echo " >>>>>>>> A-GEM "
...
##
#    echo " >>>>>>>> ER "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.05 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'er' --mem-size 1
###    echo " >>>>>>>> ER "
...
##
#    echo " >>>>>>>> Stable SGD "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.1 --gamma 0.7 --batch-size 64 --dropout 0.0 --runs 5
#
#    echo " >>>>>>>> Naive RMSProp "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.001 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'rms'

    echo " >>>>>>>> TAG-RMSProp"
    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 5 --lr 0.0005 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'tag' --b 5 --tag-opt 'rms'
#
#    echo " >>>>>>>> Naive Adagrad "
