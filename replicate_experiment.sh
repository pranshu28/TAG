...
#
#    echo " >>>>>>>> Stable SGD "
#    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task 1 --lr 0.1 --gamma 0.9 --batch-size 10 --dropout 0.0 --runs 5
#
#    echo " >>>>>>>> Naive RMSProp "
...
#
#    echo " >>>>>>>> Stable SGD "
#    python3 -m main --dataset cub --tasks 20 --epochs-per-task 1 --lr 0.05 --gamma 0.9 --batch-size 10 --dropout 0.0 --runs 5
##
#    echo " >>>>>>>> Naive RMSProp "
