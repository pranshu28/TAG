...
#    python3 -m main --dataset cub --tasks 20 --epochs-per-task 1 --lr 0.0001 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'adam'
    ...
    echo " >>>>>>>> Multi-task "
    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.01 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --multi 1

    echo " >>>>>>>> Naive SGD "
    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.01 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5

    echo " >>>>>>>> Stable SGD "
    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.005 --gamma 0.9 --batch-size 64 --dropout 0.0 --runs 5

    echo " >>>>>>>> A-GEM "
    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.01 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'agem' --mem-size 1

    echo " >>>>>>>> ER "
    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.01 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'er' --mem-size 1
#
#    echo " >>>>>>>> Naive RMSProp "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.001 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'rms'
##
#    echo " >>>>>>>> TAG-RMSProp"
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.001 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'param' --b 5 --tag-opt 'rms'

#    echo " >>>>>>>> Naive Adagrad "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.001 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'adagrad'
#
#    echo " >>>>>>>> Naive Adam "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.001 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'adam'
#
#    echo " >>>>>>>> TAG-Adagrad"
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.001 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'param' --b 5 --tag-opt 'adagrad'
#
#    echo " >>>>>>>> TAG-Adam"
