...
def taged_plot():
	...
	data4 = np.array([[ 47.04 , 1.85 ],[ 60.5 , 1.23 ],[ 49.78 , 1.56 ],[ 63.72 , 1.36 ],[ 51.82 , 1.48 ],[ 69.17 , 1.26 ],[ 57.98 , 2.89 ],[ 70.37 , 1.09 ]])
...
def naive_plot(f=''):
	...
	data2 = np.array([[ 48.19 , 0.79 , 0.13 , 0.01 ],[ 49.93 , 1.8 , 0.16 , 0.01 ],[56.99, 0.57, 0.05, 0.004],[ 42.4 , 1.13 , 0.2 , 0.02 ],[ 57.2 , 1.37 , 0.06 , 0.02 ],[ 45.92 , 1.58 , 0.2 , 0.02 ],[ 57.61 , 1.24 , 0.06 , 0.01 ]])
	data4 = np.array([[ 47.04 , 1.85 , 0.46 , 0.02 ],[ 52.07 , 1.44 , 0.41 , 0.01 ],[ 61.9 , 2.11 , 0.3 , 0.02 ],[ 46.54 , 2.64 , 0.48 , 0.05 ],[ 60.5 , 1.23 , 0.32 , 0.02 ],[ 48.11 , 1.74 , 0.49 , 0.02 ],[ 63.57 , 1.57 , 0.29 , 0.02 ]])
	data3 = np.array([[54.88, 1.83, 0.12, 0.01],[55.44, 1.22, 0.1, 0.0],[61.76, 1.04, 0.11, 0.01],[49.4, 1.77, 0.24, 0.01],[61.58, 1.24, 0.11, 0.01],[44.21, 1.98, 0.25, 0.02],[57.54, 0.83, 0.1, 0.0]])
...
def acc(dataset):
	...
	for ind, i in enumerate(range(len(ls))): #[0,2,4,6]):
		...
		# plot_means(1, dataset, ls[i+1], tasks, opt_data[ls[i+1]], opt_data[ls[i+1]+'_std'], colors[ind], style='-')
