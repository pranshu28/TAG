...
#    echo " >>>>>>>> TAG-RMSProp"
#    python3 -m main --dataset cifar100 --tasks 20 --epochs-per-task 1 --lr 0.0001 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'param' --b 5 --tag-opt 'rms'
...
#    echo " >>>>>>>> TAG-RMSProp"
#    python3 -m main --dataset cub --tasks 20 --epochs-per-task 1 --lr 0.00005 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'param' --b 5 --tag-opt 'rms'
...
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.00075 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'rms'
    ...
    echo " >>>>>>>> TAG-RMSProp"
    python3 -m main --dataset 5data --tasks 5 --epochs-per-task 1 --lr 0.0005 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'param' --b 5 --tag-opt 'rms'
