...
#    echo " >>>>>>>> OGD "
#    python3 -m main --dataset cifar100 --tasks 20 --epochs-per-task $2 --lr 0.01 --gamma 1.0 --batch-size 32 --dropout 0.0 --runs 5 --opt 'ogd' --mem-size 100
    ...
    echo " >>>>>>>> Naive SGD "
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.05 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5

    echo " >>>>>>>> EWC "
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.05 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'ewc' --lambd 1

    echo " >>>>>>>> A-GEM "
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.1 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'agem' --mem-size 1

    echo " >>>>>>>> ER "
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.05 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'er' --mem-size 1

    echo " >>>>>>>> Stable SGD "
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.1 --gamma 0.9 --batch-size 10 --dropout 0.0 --runs 5

    echo " >>>>>>>> Naive RMSProp "
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.001 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'rms'

    echo " >>>>>>>> TAG-RMSProp"
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.0001 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'tag' --b 5 --tag-opt 'rms'

    echo " >>>>>>>> Multi-task "
    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.01 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --multi 1

#    echo " >>>>>>>> OGD "
#    python3 -m main --dataset imagenet --tasks 20 --epochs-per-task $2 --lr 0.01 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 5 --opt 'ogd' --mem-size 100
...
#    echo " >>>>>>>> OGD "
#    python3 -m main --dataset cub --tasks 20 --epochs-per-task $2 --lr 0.01 --gamma 1.0 --batch-size 10 --dropout 0.0 --runs 1 --opt 'ogd' --mem-size 50
...
#    echo " >>>>>>>> OGD "
#    python3 -m main --dataset 5data --tasks 5 --epochs-per-task $2 --lr 0.01 --gamma 1.0 --batch-size 64 --dropout 0.0 --runs 5 --opt 'ogd' --mem-size 100
